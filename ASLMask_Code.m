classdef ASLMask_Code < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.StartAgainButton.FontSize = 15;
            app.StartAgainButton.Visible = 'off';
            app.StartAgainButton.Position = [766 19 97 58];
            ...
            app.CBFDisplayButton.FontSize = 16;
            app.CBFDisplayButton.Visible = 'off';
            app.CBFDisplayButton.Position = [722 190 185 59];
            ...
            app.PrepareButton.FontSize = 16;
            app.PrepareButton.Visible = 'off';
            app.PrepareButton.Position = [722 386 185 59];
            ...
            app.ErrorLabel.Visible = 'off';
            app.ErrorLabel.Position = [687 346 253 31];
            ...
            app.PREPARATIONCOMPLETELabel.Visible = 'off';
            app.PREPARATIONCOMPLETELabel.Position = [723 346 180 31];
            ...
            app.SelectDirectoryButton.Position = [716 522 185 59];
            ...
            app.WelcomePleaseselectyourdirectoryLabel.Position = [654 580 305 35];
            ...
            app.YourdirectoryEditFieldLabel.Position = [767 455 81 22];
            ...
            app.YourdirectoryEditField.Position = [647 476 321 31];
            ...
            app.MoreDisplayOptionsButton.FontSize = 15;
            app.MoreDisplayOptionsButton.Visible = 'off';
            app.MoreDisplayOptionsButton.Position = [741 95 143 68];
            ...
            app.MaskButton.Visible = 'off';
            app.MaskButton.Position = [722 276 185 59];
            ...
            app.PleaseWaitLabel.Visible = 'off';
            app.PleaseWaitLabel.Position = [723 346 180 31];
            ...
            app.UIAxes_2row_1.Position = [53 566 914 141];
            ...
            app.UIAxes_2row_2.Position = [53 376 914 141];
            ...
            app.UIAxes_2row_3.Position = [53 188 914 141];
            ...
            app.UIAxes_2row_4.Position = [53 10 914 141];
            ...
            app.UIAxes_3row_1.Position = [125 614 788 91];
            ...
            app.UIAxes_3row_2.Position = [125 490 788 91];
            ...
            app.UIAxes_3row_3.Position = [126 371 788 91];
            ...
            app.UIAxes_3row_4.Position = [126 245 788 91];
            ...
            app.UIAxes_3row_5.Position = [126 124 788 91];
            ...
            app.UIAxes_3row_6.Position = [126 5 788 91];
            ...
            app.ReturnHomeButton.Position = [22 732 57 52];
            ...
            app.MASKINGCOMPLETELabel.Visible = 'off';
            app.MASKINGCOMPLETELabel.Position = [435 190 220 39];
            ...
            app.returnHomeButton2.Position = [37 28 68 56];
